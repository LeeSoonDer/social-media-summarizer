---
name: vibesec-skill
description: Helps write secure web applications from a bug hunter perspective. Use when building web apps, Chrome extensions with APIs/storage, or when the user requests a security scan or audit.
---
